...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2023 at 10:57 PM
...
INSERT INTO `courses` (`id`, `name`, `type`, `description`, `price`, `coach_id`) VALUES
(1, 'Swimming', 'Individual', 'Magnificent Course', 500.00, 2);
...
('root', '[{\"db\":\"gymify\",\"table\":\"members\"},{\"db\":\"gymify\",\"table\":\"managers\"},{\"db\":\"gymify\",\"table\":\"courses\"},{\"db\":\"gymify\",\"table\":\"coaches\"},{\"db\":\"gymify\",\"table\":\"joined_courses\"},{\"db\":\"gymify\",\"table\":\"plans\"},{\"db\":\"gymify\",\"table\":\"products\"}]');
...
('root', '2023-06-27 20:56:56', '{\"Console\\/Mode\":\"collapse\"}');
